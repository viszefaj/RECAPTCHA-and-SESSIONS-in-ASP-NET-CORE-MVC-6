...
namespace Sisteme1.Areas.Identity.Pages.Account
{
    ...
    public class RegisterModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            [StringLength(255, ErrorMessage = "The First Name Field a Maximum of 255")]
            [MinLength(5)]
            public string FirstName { get; set; }

            [Required]
            [Display(Name = "Lastname")]
            [StringLength(255, ErrorMessage = "The Last Name Field a Maximum of 255")]
            [MinLength(5)]
